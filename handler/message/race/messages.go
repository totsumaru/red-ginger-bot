...
// =================================================
// 以下、ハロウィン仕様のため、一時的な実装です。
// =================================================

// -2pt
var pointM2 = []Res{
	{point: -2, text: "は、カボチャにぶつかり転んでしまった！⏬"},
	{point: -2, text: "は、カボチャにつまずいてしまった！⏬"},
	{point: -2, text: "は、魔女の仮装がもつれて転倒！⏬"},
	{point: -2, text: "は、「いたずら」の意味を誤解している⏬"},
	{point: -2, text: "から、オイルが漏れている…血糊の演出ではない！⏬"},
	{point: -2, text: "は、もらったお菓子を落としてしまった！⏬"},
	{point: -2, text: "は、迷惑な路上飲みにぶつかってしまった！⏬"},
	{point: -2, text: "は、リアルなゾンビ仮装で焼き肉を食べに行き、炎上した！⏬"},
	{point: -2, text: "は、ハロウィンメイクしなくてもゾンビっぽいことに愕然とした！⏬"},
	{point: -2, text: "は、迷惑なハロウィンパーティーを計画して嫌われた⏬"},
	{point: -2, text: "は、黒猫を探しに行ってコースアウト！！！⏬"},
	{point: -2, text: "は、カボチャを模したヘルメットが重くスピードが出ない！！⏬"},
	{point: -2, text: "は、近所のおばあちゃんをゾンビと見間違い怒られる💢"},
	{point: -2, text: "は、自分だけアルフォートを貰えずショックで立ち止まる⏬"},
	{point: -2, text: "は、母の妖精仮装に意識を失う🧚"},
	{point: -2, text: "は、ミイラ仮装で手足もまとめて包帯巻いたので、動けない⏬"},
}

// -1pt
var pointM1 = []Res{
	{point: -1, text: "は、お菓子が欲しくてペースダウン🍪"},
	{point: -1, text: "は、妖精の仮装でお腹が冷えてトイレに行きたい…🚽"},
	{point: -1, text: "は、魔女の衣装が引っかかり遅れた🧙‍♀️"},
	{point: -1, text: "は、「トリック・オア・トリート」の意味が分からない⏬"},
	{point: -1, text: "から、煙が出ている…魔法の演出ではない！スピードダウン！⏬"},
	{point: -1, text: "は、魔女仮装の黒いローブがからまって失速！⏬"},
	{point: -1, text: "は、月見バーガーを買いに行った🍔"},
	{point: -1, text: "は、コウモリ型のクッキーにイカ墨を入れた！不味かった！🦑"},
	{point: -1, text: "は、買ってきたバットマンの衣装が短パンだった！🦇"},
	{point: -1, text: "は、買ってきたスパイダーマンの衣装がノースリーブだった！🕸️"},
	{point: -1, text: "は、買ってきたスーパーマンの衣装がスースルーだった！🦸‍♂️"},
	{point: -1, text: "は、ハロウィンパーティーに仮装して行ったが誰も仮装していなかった⏬"},
	{point: -1, text: "は、フランケンの頭のネジが妙に気になり減速⏬"},
	{point: -1, text: "は、仮装しているだけなのに、何故が自分だけ職質を食らう👮"},
	{point: -1, text: "は、街中で黒猫仮装の父を発見し、その場から無言で立ち去る⏬"},
	{point: -1, text: "は、不運（ハードラック）とダンスっちまった⏬"},
}

// 0pt
var point0 = []Res{
	{point: 0, text: "は、ジャック・オー・ランタンが好きだけど…実は怖い🎃"},
	{point: 0, text: "は、何故か「ウィッチ」という響きが恥ずかしくてモジモジしちゃう！⏩"},
	{point: 0, text: "は、蜘蛛の巣まみれで視界不良！！🕸️"},
	{point: 0, text: "は、ハロウィンパーティーに誘われていない⏩"},
	{point: 0, text: "は、ゴーストの仮装で白いシーツをまとっている👻"},
	{point: 0, text: "だけ、キャンディーをもらえなかったことに気が付いていない🍭"},
	{point: 0, text: "は、ハッカ味キャンディーが苦手だ！⏩"},
	{point: 0, text: "は、キャンディーよりチョコレートが好き！🍫"},
	{point: 0, text: "は、お菓子に夢中だ！！！！🍩"},
	{point: 0, text: "は、ハロウィンパーティーの仮装ですべる⏩"},
	{point: 0, text: "は、みんなの仮装に怯えてる（ガタガタガタ）😱"},
	{point: 0, text: "は、リアルめの蜘蛛仮装をしたため、動きにくくて皆とはぐれる🕷️"},
	{point: 0, text: "は、ドラキュラ衣装の襟が邪魔で皆とはぐれる🧛"},
	{point: 0, text: "は、畑のカカシを人間だと思って話し込んでいるおばあさんをずっと見守る⏩"},
	{point: 0, text: "は、ハロウィンジャンボ宝くじを連番で購入した⏩"},
	{point: 0, text: "は、ティッシュペーパーで包んだキャンディーをもらった🍭"},
}

// 1pt
var point1 = []Res{
	{point: 1, text: "は、仮装の血糊がいちごジャム🍓"},
	{point: 1, text: "は、自分のハロウィンカスタムに満足げ⏫"},
	{point: 1, text: "が、もらったキャンディーはのど飴だった！🍬"},
	{point: 1, text: "は、狼男の仮装がクールで周りの評価が高かった！⏫"},
	{point: 1, text: "が考案したハロウィンカクテルは、橋本界隈でブレイク中！🍸"},
	{point: 1, text: "は、ボディーにRED GINGERのロゴステッカーを貼っている！⏫"},
	{point: 1, text: "は、F-1レーサーの仮装をし、速くなった気がした！⏫"},
	{point: 1, text: "は、隣のおばさんに高級チョコレートをもらった🍫"},
	{point: 1, text: "は、片思い中の同級生からハロウィンパーティーに誘われた💕"},
	{point: 1, text: "は、吸血鬼の仮装がお洒落だと褒められた🧛"},
	{point: 1, text: "は、ハロウィン仮装をきっかけにアパレルブランド考案中👗"},
	{point: 1, text: "は、カップル仮装の相方を募集中！⏫"},
	{point: 1, text: "の肌着は、コウモリの柄が入っている🦇"},
	{point: 1, text: "の勝負パンツに「Trick or Treat」と書いてある！🩲"},
	{point: 1, text: "は、トリート・バッグを持参した🛍️"},
	{point: 1, text: "は、魔女と黒猫が大好きだ！🧙‍♀️"},
}

// 2pt
var point2 = []Res{
	{point: 2, text: "は、友達のお母さんの魔女仮装にドキドキしている⏫"},
	{point: 2, text: "は、迷惑な路上飲みに注意をしている！⏫"},
	{point: 2, text: "は、吸血鬼のマントをなびかせて加速！🧛"},
	{point: 2, text: "は、カボチャ料理のお弁当を持ってきて、好感度が上がった！📈"},
	{point: 2, text: "は、ドラキュラ伯爵の仮装をして紳士的イケオジになった！🧛‍♂️"},
	{point: 2, text: "は、狼男のように遠吠えしながら加速！⏫"},
	{point: 2, text: "は、ゾンビのように復活！徐々にスピードアップ！🧟"},
	{point: 2, text: "の、殺人鬼仮装が怖がられて、走りやすくなった。⏫"},
	{point: 2, text: "、チュパ、チュパ、チュパカブラーーーー！！⏫"},
	{point: 2, text: "は、ゴーストような走り、ふわふわとすり抜ける！👻"},
	{point: 2, text: "は、インナーにRED GINGERのロゴＴシャツを着ている！👕"},
	{point: 2, text: "は、まるでグリムリーパー！死神の走り！💀"},
	{point: 2, text: "は、まるで黒猫のようにしなやかに走る！⏫"},
	{point: 2, text: "は、ハロウィンではしゃぐ子供のようにトリッキーに曲がる！⏫"},
	{point: 2, text: "は、ハロウィンミュージックのプレイリストを作ってきた！🎧"},
	{point: 2, text: "の心の中は、ハロウィンデコレーションでいっぱいだ！⏫"},
}

// 3pt
var point3 = []Res{
	{point: 3, text: "は、魔女の仮装を見て心の中の新しい扉が開いた！🧙‍♀️"},
	{point: 3, text: "は、レースクイーンのハロウィン仮装に激しく萌えている！👗"},
	{point: 3, text: "は、フランケンシュタインのような力強い加速！⏫"},
	{point: 3, text: "は、猫耳をつけたら人気が爆上がりした！⏫"},
	{point: 3, text: "は、黒猫仮装のレオタードにやる気がみなぎった！🩱"},
	{point: 3, text: "は、ハロウィンデコレーションの出費が６桁だ！💴"},
	{point: 3, text: "は、超ミニスカ魔女仮装！恥ずかしくてスピードアップした！⏫"},
	{point: 3, text: "は、ハロウィンパーティーを百鬼夜行と勘違いし猛スピードで逃げた！⏫"},
	{point: 3, text: "は、ハロウィンメイクがハードロックバンドの様で人気が出た！🎸"},
	{point: 3, text: "は、悪魔的な性能を発揮し、フル加速！！😈"},
	{point: 3, text: "は、幼馴染とのハロウィンパーティーで、本当の気持ちに気づいた！❤"},
	{point: 3, text: "は、昨夜のハロウィンハーティーで運命のメカと出逢った…💘"},
	{point: 3, text: "は、スライムのドロドロが潤滑油になり走力アップ⏫"},
	{point: 3, text: "は、ブラック・ウィドウのようなアタックでコーナーを攻める！⏫"},
	{point: 3, text: "は、ウィッチ・ドクターの呪いの様にライバルのミスを誘う！⏫"},
	{point: 3, text: "、たとえ悪魔でも、オレはコイツがいい…ただそれだけだ！⏫"},
}

// 6pt
var point6 = []Res{
	{point: 6, text: "は、お菓子が欲しさに全力疾走！🍰"},
	{point: 6, text: "は、狼男になりきって爆走！スピードアップ！！！🐺"},
	{point: 6, text: "は、ハロウィンメイクが、むずがゆくなって猛ダッシュ！！！⏫"},
	{point: 6, text: "は、露出の多い魔女コスに興奮し、眉間から電流を放った！⚡"},
	{point: 6, text: "は、心のエンジンを１万１千回転まできっちり回した！！！⏫"},
	{point: 6, text: "は、ぶつかったカボチャを破壊し急加速！！！💥"},
	{point: 6, text: "は、ハロウィンの仮装を脱ぎ捨て、真剣勝負に出た！！！⏫"},
	{point: 6, text: "は、魔女の仮装ではなく、本物の魔女の衣装を纏っていた！！⏫"},
	{point: 6, text: "は、お菓子を貰えなかったことに激怒！猛スピードで突っ走る！！💢"},
	{point: 6, text: "は、叫びながら加速…魔女！魔女！魔女！魔女！熟女！魔女！魔女！🧙‍♀️"},
	{point: 6, text: "は、呪文を唱えたら本当に魔法が使えて瞬間移動！！！⏫"},
	{point: 6, text: "は、ラストスパート！魔女の帽子が吹き飛んだ！！！！⏫"},
	{point: 6, text: "、ホデテコの中のホデテコだーーーー！！！！⏫"},
	{point: 6, text: "は、魔女の靴下をゲットして歓喜！！ミラクルパワー！！！！🧦"},
	{point: 6, text: "は、キャンディコーンを大量に摂取！！爆発的加速を得た！！！⏫"},
	{point: 6, text: "、ハッピ～ハロウィ～～～～～～～～～ン！！！！！🎃"},
}
